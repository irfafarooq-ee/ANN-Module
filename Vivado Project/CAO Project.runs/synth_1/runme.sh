...
HD_PWD='C:/Vivado Projects/CAO Project/CAO Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ANN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ANN.tcl
